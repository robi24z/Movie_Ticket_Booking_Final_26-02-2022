...
.six21 {
	background-image: url("comingsoon2.jpg");
	background-size: contain;
	width: 240px;
	height: 350px;
	margin-left: 50px;
...
.six31 {
	background-image: url("comingsonn3.jpg");
	background-size: contain;
	width: 240px;
	height: 350px;
	margin-left: 50px;
...
.six41 {
	background-image: url("comingsoon4.jpg");
	background-size: contain;
	width: 240px;
	height: 350px;
	margin-left: 50px;
...
<body>
	<div class="one">
		<div class="two">
			...
			<div class="two2">
				<a href="movieLogin.jsp">Movies</a>
			</div>
			<div class="two3">
		...
		<div class="six">
			<div class="six1">
				<div class="six11">
					<a href="movieOne.jsp">Thalli Pogathey - Tamil</a>
				</div>
			</div>
			<div class="six2">
				<div class="six11">Rocky - Tamil</div>
			</div>
			<div class="six3">
				<div class="six11">Shyam Singha Roy - Telugu</div>
			</div>
			<div class="six4">
				<div class="six11">Enna Solla Pogirai - Tamil</div>
			</div>

		</div>
		<div class="fivee">Coming Soon</div>
		<div class="sixx">
			<div class="six12">
				<div class="six11">Meppadiyan - Malayalam</div>
			</div>
			<div class="six21">
				<div class="six11">Coffee - Marathi</div>
			</div>
			<div class="six31">
				<div class="six11">Rattham Ranam Rowthiram - Tamil</div>
			</div>
			<div class="six41">
				<div class="six11">Hridayam - Malayalam</div>
			</div>
		</div>
		<div class="seven">
			<div class="seven1">
